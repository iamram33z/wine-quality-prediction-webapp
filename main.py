...
from wine_quality_prediction.pipeline.stage_04_model_training import \
...
try:
    ...
    logger.info(
        f"{Fore.GREEN}>>>>> The {STAGE_1_NAME} Pipeline Completed Successfully! <<<<<{Style.RESET_ALL}\n"
    )
...
try:
    ...
    logger.info(
        f"{Fore.GREEN}>>>>> The {STAGE_2_NAME} Pipeline Completed Successfully! <<<<<{Style.RESET_ALL}"
    )
except Exception as e:
    logger.exception(e)
    raise e
...
try:
    ...
    logger.info(
        f"{Fore.GREEN}>>>>> The {STAGE_3_NAME} Pipeline Completed Successfully! <<<<<{Style.RESET_ALL}"
    )
except Exception as e:
    logger.exception(e)
    raise e
...
try:
    ...
    logger.info(
        f"{Fore.GREEN}>>>>> The {STAGE_4_NAME} Pipeline Completed Successfully! <<<<<{Style.RESET_ALL}"
    )
except Exception as e:
    logger.exception(e)
    raise e
...
try:
    ...
    logger.info(
        f"{Fore.GREEN}>>>>> The {STAGE_5_NAME} Pipeline Completed Successfully! <<<<<{Style.RESET_ALL}"
    )
except Exception as e:
    logger.exception(e)
    raise e
